...
export default function KitchenOrder() {
  ...
  return (
    <div>
      ...
      <Button onClick={() => handleTableButtonClick(1)}>Table 1</Button>
      <Button onClick={() => handleTableButtonClick(2)}>Table 2</Button>
      <Button onClick={() => handleTableButtonClick(3)}>Table 3</Button>
