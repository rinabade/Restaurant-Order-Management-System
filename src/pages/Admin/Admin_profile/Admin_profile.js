      ...
      <div className='glass p-3 rounded w-50'>
        ...
        <form>
          ...
          <div className='change flex-row d-flex justify-content-around'>
            <button type='button' className='btn btn2 rounded-12' onClick={handleChangeInformation} >
              Change Information
            </button>
            <button type='button' className='btn btn2 rounded-12 '  onClick={handleChangePassword} >
              Change password
            </button>
          </div>
        </form>
        {isChangingInformation && (
          <div className='dialog-overlay1'>
            ...
            >
              ...
              <input type="text" placeholder='Enter First name' name='name' className="form-control rounded-0" required />
               </div>
               <div className='mb-3'>
              <label htmlFor="name">Last name</label>
              <input type="text" placeholder='Enter Last name' name='name' className="form-control rounded-0" required />
               </div>
               </div>
               <div className='d-flex flex-row justify-content-around'>
               <div className='mb-3'>
              <label htmlFor="name">Email</label>
              <input type="email" placeholder='Enter email' name='name' className="form-control rounded-0" required />
               </div>
               <div className='mb-3'>
              <label htmlFor="name">Address</label>
              <input type="text" placeholder='Enter address' name='name' className="form-control rounded-0" required />
               </div>
               </div>
               <div className='mb-3'>
              <label htmlFor="name">Phone number</label>
              <input type="number" placeholder='Enter phone number' name='name' className="form-control rounded-0" required />
               </div>
                <Button type='submit' label='Save Changes' className='btn bg-success text-white' />
              </form>
            </Dialog>
          </div>
        )}
        {isChangingPassword && (
          <div className='dialog-overlay1'>
            ...
            >
              ...
              <input type="password" placeholder='Enter Current password' name='name' className="form-control rounded-0" required />
               </div>
               <div className='mb-3'>
              <label htmlFor="name">New password</label>
              <input type="password" placeholder='Enter New password' name='name' className="form-control rounded-0" required />
               </div>
               <div className='mb-3'>
              <label htmlFor="name">Confirm password</label>
              <input type="password" placeholder='Enter New password' name='name' className="form-control rounded-0" required />
               </div>
                <Button type='submit' label='Save Password' className='btn bg-success text-white' />
              </form>
            </Dialog>
          </div>
        )}
